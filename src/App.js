...
function App() {
    ...
    const handleAlert =() =>{
        Swal.fire({
            title: '<strong>Congratulations! Form Submitted</strong>',
            icon: 'success',
            html:
              `Name:<b>${formData.name}</b>` + '</br>' +
              `Phone:<b>${formData.phone}</b>` + '</br>' +
              `Age:<b>${formData.age}</b>` + '</br>' +
              `Country:<b>${formData.country}</b>` +  '</br>' +
